...
Das Capistrano deploy.rb liegt bei unter:

    config/deploy.rb
	
database.yml und deploy.rb der eigenen Konfiguration anpassen. Dann der erste Deploy:
...
In crontab:
    ...
    rake thinkgin_sphinx:index RAILS_ENV=production
